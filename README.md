...
**74 tools + 1 reference resource** across nine categories. Six of them are impossible without unified GSC+GA4 auth, and v0.2 adds Lighthouse, CrUX, Schema validation, IndexNow, and Google Trends/Suggest — the SEO swiss knife in one binary.
